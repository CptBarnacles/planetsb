...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { first_name: @sponsor.first_name, last_name: @sponsor.last_name, planet_id: @sponsor.planet_id, user_id: @sponsor.user_id } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { first_name: @sponsor.first_name, last_name: @sponsor.last_name, planet_id: @sponsor.planet_id, user_id: @sponsor.user_id } }
